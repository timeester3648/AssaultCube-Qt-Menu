...
namespace EOUL::Parser {
	...
	class BaseParser {
		...
		public:
			...
			inline BaseParser(std::filesystem::path path) : path(std::move(path)) {

			}

			inline BaseParser(BaseParser&& other) noexcept {
		...
		public:
			...
			/* swaps 2 BaseParsers */
			inline void swap(BaseParser& other) noexcept {
	...
	class PropertiesParser : public BaseParser {
		...
		public:
			...
			inline PropertiesParser(std::filesystem::path path) : BaseParser(std::move(path)) {

			}

			inline PropertiesParser(PropertiesParser&& other) noexcept {
		...
		public:
			...
			inline void swap(PropertiesParser& other) noexcept {
	...
	class ConfigParser : public BaseParser {
		...
		public:
			...
			inline ConfigParser(std::filesystem::path path) : BaseParser(std::move(path)) {

			}

			inline ConfigParser(ConfigParser&& other) noexcept {
		...
		public:
			...
			/* swaps 2 PropertiesParsers */
			inline void swap(ConfigParser& other) noexcept {
	...
	class IniParser : public BaseParser {
		...
		public:
			...
			inline IniParser(std::filesystem::path path) : BaseParser(std::move(path)) {

			}

			inline IniParser(IniParser&& other) noexcept {
		...
		public:
			...
			/* swaps 2 PropertiesParsers */
			inline void swap(IniParser& other) noexcept {
			...
			/* returns if the given key is parsed from the file */
			inline bool hasKey(const std::string& key, const std::string& section = "") const {
