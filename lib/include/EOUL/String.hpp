...
namespace EOUL::Util {
	...
	template <typename StringType1 = std::string, typename StringType2 = std::string>
	inline bool startsWith(const StringType1& str, const StringType2& prefix) {
	...
	template <typename StringType1 = std::string, typename StringType2 = std::string>
	inline bool contains(const StringType1& str, const StringType2& part) {

		return str.find(part) != StringType1::npos;
	...
	inline void replace(StringType& str, const StringType& toReplace, const StringType& toReplaceWith) {
		...
		while ((pos = str.find(toReplace)) != StringType::npos) {
	...
	inline void splitString(Container& cont, const StringType& str, const StringType& delimiter = " ") {
	...
	template <typename StringType = std::string>
	inline std::vector<StringType> splitString(const StringType& str, const StringType& delimiter = " ") {

		std::vector<StringType> arr;

		splitString<std::vector<StringType>, StringType>(arr, str, delimiter);
